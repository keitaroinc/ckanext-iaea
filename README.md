...
2. Clone the source and install it on the virtualenv
    ...
    git clone https://github.com/keitaroinc/ckanext-iaea.git
    cd ckanext-iaea
    pip install -e .
...
## Releasing a new version of ckanext-iaea

If ckanext-iaea should be available on PyPI you can follow these steps to publish a new version:
